...
culmen_depth_input = st.number_input('Enter culmen depth:', 0, 50, 37)
flipper_length_input = st.number_input('Enter flipper length:', 0, 200, 37)
body_mass_input = st.number_input('Enter body mass in g:', 0,1000,5000)
