...
# Load model
with open('model-penuin-64139701906.pkl', 'rb') as file:
...
culmen_depth_input = st.slider('Enter culmen depth:', 0, 50, 37)  # Corrected typo here
flipper_length_input = st.slider('Enter flipper length:', 0, 200, 37)
body_mass_input = st.slider('Enter body mass in g:', 0, 10000, 5000)  # Adjusted the range for body mass
